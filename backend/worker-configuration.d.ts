/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b2765f7ef2a0c8d0d50d14a7c0e9be04)
// Runtime types generated with workerd@1.20260710.1 2026-05-31 nodejs_compat
interface __BaseEnv_Env {
	VOICE_NOTES: R2Bucket;
	GALLERY: R2Bucket;
	ANTHROPIC_API_KEY: SecretsStoreSecret;
	ELEVENLABS_API_KEY: SecretsStoreSecret;
	GETIMG_API_KEY: SecretsStoreSecret;
	HA_MCP_URL: SecretsStoreSecret;
	HA_TOKEN: SecretsStoreSecret;
	NOTION_TOKEN: SecretsStoreSecret;
	ASSETS: Fetcher;
